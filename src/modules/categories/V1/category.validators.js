...
const childSubCategorySchema = yup.object().shape({
  title: yup
    .string()
    .required("Title is required") // Title is required
    .min(3, "Title must be at least 3 characters long"), // Title must be at least 3 characters long
...
const updateChildSubCategorySchema = yup.object().shape({
  title: yup.string().min(3, "Title must be at least 3 characters long"), // Title must be at least 3 characters long
  slug: yup
    .string()
    .matches(
  ...
  filters: yup
    ...
    .of(
      yup.object().shape({
        ...
        type: yup.string().oneOf(["selectbox", "radio"], "Invalid filter type"), // Filter type must be either "selectbox" or "radio" // Filter type is required
        description: yup.string().optional(), // Filter description is optional
        options: yup.array().of(yup.string()),
      })
    )
